        ...
        <nav className="flex flex-col items-center gap-4 px-2 sm:py-4">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
                to="#"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-neutral-100 text-neutral-900 transition-colors hover:text-neutral-950 md:h-8 md:w-8 dark:bg-neutral-800 dark:text-neutral-50 dark:hover:text-neutral-50"
              >
      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="sm:max-w-xs">
              <nav className="grid gap-6 text-lg font-medium">
                ...
                <Link to="#" className="flex items-center gap-4 px-2.5 text-neutral-950 dark:text-neutral-50">
                  <ShoppingCart className="h-5 w-5" />
                  Orders
                </Link>
                <Link
        ...
        <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-3 xl:grid-cols-3">
          <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
              ...
              <Card x-chunk="A stats card showing this week's total sales in USD, the percentage difference from last week, and a progress bar.">
                ...
                <CardContent>
                  <div className="text-xs text-neutral-500 dark:text-neutral-400">+25% from last week</div>
                </CardContent>
                <CardFooter>
              ...
              <Card x-chunk="A stats card showing this month's total sales in USD, the percentage difference from last month, and a progress bar.">
                ...
                <CardContent>
                  <div className="text-xs text-neutral-500 dark:text-neutral-400">+10% from last month</div>
                </CardContent>
                <CardFooter>
                      ...
                      <TableBody>
                        <TableRow className="bg-neutral-100 dark:bg-neutral-800">
                          <TableCell>
                            ...
                            <div className="hidden text-sm text-neutral-500 md:inline dark:text-neutral-400">
                              liam@example.com
                            </div>
                          </TableCell>
          ...
          <div>
            ...
            >
              <CardHeader className="flex flex-row items-start bg-neutral-100/50 dark:bg-neutral-800/50">
              ...
              <CardContent className="p-6 text-sm">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-3">
                    ...
                    <address className="grid gap-0.5 not-italic text-neutral-500 dark:text-neutral-400">
                  ...
                  <div className="grid auto-rows-max gap-3">
                    ...
                    <div className="text-neutral-500 dark:text-neutral-400">Same as shipping address</div>
                  </div>
                </div>
                <Separator className="my-4" />
                <div className="grid gap-3">
                ...
                <div className="grid gap-3">
                  ...
                  <dl className="grid gap-3">
                    <div className="flex items-center justify-between">
                      <dt className="flex items-center gap-1 text-neutral-500 dark:text-neutral-400">
              ...
              <CardFooter className="flex flex-row items-center border-t bg-neutral-100/50 px-6 py-3 dark:bg-neutral-800/50">
